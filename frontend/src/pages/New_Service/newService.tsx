...
export default function NewService() {
  ...
  useEffect(() => {
    if (apiresponse && apiresponse.validateApi) {
      ...
      if (!apiresponse?.validateApi?.success) {
        SetSnackbarFields(
          true,
          apiresponse?.validateApi?.message || 'Invalid API!',
          'error'
        );
      }
  ...
  if (businessUnitsError)
    return <p>Error loading Business Units: {businessUnitsError.message}</p>;
            ...
            <TabContext value={tabValue}>
              ...
              <TabPanel value="2">
                {authTypeChoicesLoading ? (
                  ...
                  <p>
                    Error loading Authorization Types:{' '}
                    {authTypeChoicesError.message}
                  </p>
                ) : (
                  <Grid container>
              ...
              <TabPanel value="3">
                <FormControl>
                  <RadioGroup row value={bodyType} onChange={handleBodychange}>
                    <FormControlLabel
                      value="none"
